  ...
  if ((*iLBCdec_inst).use_enhancer == 1) { /* Enhancer activated */
    ...
    if (iLBCdec_inst->mode==20) {
      ...
      WebRtcSpl_FilterARFastQ12(
        ...
        //printf("-----------------------WebRtcSpl_FilterARFastQ12---222\n");

      for (i=1; i < iLBCdec_inst->nsub; i++) {
          //printf("-----------------------WebRtcSpl_FilterARFastQ12---333\n");
        WebRtcSpl_FilterARFastQ12(
      ...
      for (i=0; i < 2; i++) {
          //printf("-----------------------WebRtcSpl_FilterARFastQ12---444\n");
        WebRtcSpl_FilterARFastQ12(
            data+i*SUBL, data+i*SUBL,
      ...
      for (i=2; i < iLBCdec_inst->nsub; i++) {
          //printf("-----------------------WebRtcSpl_FilterARFastQ12---555\n");
        WebRtcSpl_FilterARFastQ12(
            data+i*SUBL, data+i*SUBL,
    ...
    for (i=0; i < iLBCdec_inst->nsub; i++) {
        //printf("-----------------------WebRtcSpl_FilterARFastQ12---111\n");
      WebRtcSpl_FilterARFastQ12(
          data+i*SUBL, data+i*SUBL,
