...
void WebRtcIlbcfix_Smooth(
  ...
  //max1=WebRtcSpl_MaxAbsValueW16(current, ENH_BLOCKL);
                              ...
                              if (1) {
                                  ...
                                  int16_t* vectorCustom = current;
                                  int lengthCustom = ENH_BLOCKL;
                                  ...
                                  if (vectorCustom == NULL || lengthCustom <= 0) {
                                      ...
                                      if (max1 > WEBRTC_SPL_WORD16_MAX) {
                                          max1 = WEBRTC_SPL_WORD16_MAX;
                                      }
                                  }
                              }
  ...
  //max2=WebRtcSpl_MaxAbsValueW16(surround, ENH_BLOCKL);
                              ...
                              if (1) {
                                  ...
                                  if (vectorCustom == NULL || lengthCustom <= 0) {
                                      ...
                                      if (max2 > WEBRTC_SPL_WORD16_MAX) {
                                          max2 = WEBRTC_SPL_WORD16_MAX;
                                      }
                                  }
                              }
